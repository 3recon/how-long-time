import { demoRecommendationScenarios } from "@/data/demo/recommendation-sample";
import type { RecommendRequest, RecommendResponse } from "@/types/recommend";

const recommendContractVersion = "2026-04-stage-7";
const purposeMappingVersion = "2026-04-stage-4";
