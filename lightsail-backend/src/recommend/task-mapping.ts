import { purposeTaskMappings } from "../data/recommend/task-mappings.js";
import type { PublicDataWaitingItem } from "../contracts/public-data.js";
import type {
  MatchingRuleType,
  PurposeTaskMapping,
  PurposeTaskRule,
...
export function getPurposeTaskMapping(
  ...
  if (!mapping) {
    throw new Error(`Unsupported purpose id: ${purposeId}`);
  }
